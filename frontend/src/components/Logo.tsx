  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span className="text-lg text-center border rounded-full bg-accent/30 border-border font-semibold text-foreground mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity">
            <span>Meetily</span>
          </span>
        </DialogTrigger>
      )}
